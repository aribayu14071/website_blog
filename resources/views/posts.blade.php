...
<div class="card mb-3">
  ...
  @endif
    <div class="position-absolute px-3 py-2" style="background-color: rgba(231, 231, 231, 0.473)"><a href="/posts?category={{ $posts[0]->category->slug }}" class="text-dark text-decoration-none">{{ $posts[0]->category->name }}</a></div>
    ...
    <div class="card-body text-center">
      ...
      <a href="/posts/{{ $posts[0]->slug }}" class="text-decoration-none btn btn-primary">Reed more</a>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            <div class="card">
                <div class="position-absolute px-3 py-2" style="background-color: rgba(231, 231, 231, 0.473)"><a href="/posts?category={{ $post->category->slug }}" class="text-dark text-decoration-none">{{ $post->category->name }}</a></div>
                @if($post->image)
